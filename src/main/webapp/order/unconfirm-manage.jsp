        ...
        <div class="inner">
            <table>
                ...
                <c:forEach var="item" items="${orders}">
                    <tr>
                        <td><a href="/unconfirmed-orders?action=search&id=${item.id}">${item.id}</a></td>
                        <td>${item.customer.name}</td>
                        <td>${item.orderDate}</td>
                        <td>${item.totalAmount}</td>
                        <td>
                            <a href="/order-management?action=confirm&id=${item.id}" class="btn btn-primary ">Xác nhận</a>
                            <a href="/order-management?action=delete&id=${item.id}" class="btn btn-danger ">Hủy</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
